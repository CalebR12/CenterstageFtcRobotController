...
@Autonomous(name="A_RedBackDrop_new", group="ACenterStage")
public class AutoRedBDRR_new extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence RedCenter= drive.trajectorySequenceBuilder(new Pose2d(0,0,Math.toRadians(0.00)))
             ...
             //   .UNSTABLE_addTemporalMarkerOffset(0.1,() -> attach.Claw.setPosition(0.35))
                .lineToLinearHeading(new Pose2d(8, 60, Math.toRadians(0)))
              //  .addTemporalMarker(() -> attach.Claw.setPosition(0.35)) // Raise servo
               // .addTemporalMarker(() -> myEncoderLift("ROBOT_DOWN", 0.8, 5, 3,false))
               // .addTemporalMarker(() -> attach.rRotate.setPosition(0))
              ...
              .lineToLinearHeading(new Pose2d(18, 70.5, Math.toRadians(68)))
             //      .lineToLinearHeading(new Pose2d(18.5, 73.5, Math.toRadians(68)))
                //    .waitSeconds(.2)
                .UNSTABLE_addTemporalMarkerOffset(0.1,() -> attach.rClaw.setPosition(0.25))
          ...
          //      .lineToLinearHeading(new Pose2d(4, 60, Math.toRadians(90)))
            ...
            //    .UNSTABLE_addTemporalMarkerOffset(0.3, () -> myEncoderLift("ROBOT_DOWN", 0.8, 3, 3,false))
               ...
               // .lineToLinearHeading(new Pose2d(10, -26, Math.toRadians(0)))
                ...
                .addTemporalMarker(28,() -> attach.rClaw.setPosition(0))
                .build();
        ...
        TrajectorySequence RedRight= drive.trajectorySequenceBuilder(new Pose2d(0,0,Math.toRadians(0.00)))
                ...
                .lineToConstantHeading(new Vector2d(13, 1))
            //    .lineToConstantHeading(new Vector2d(10, -8))
               ...
               // .UNSTABLE_addTemporalMarkerOffset(0.1,() -> attach.Claw.setPosition(0.35))
                ...
                // .addTemporalMarker(() -> attach.rRotate.setPosition(0))
                .UNSTABLE_addTemporalMarkerOffset(0.1,() -> attach.rRotate.setPosition(0))
                .UNSTABLE_addTemporalMarkerOffset(0.3, () -> myEncoderLift("ROBOT_DOWN", 0.8, 3.8, 3,false))
                .lineToLinearHeading(new Pose2d(17.5, 71, Math.toRadians(68)))
                //    .waitSeconds(.2)
                .UNSTABLE_addTemporalMarkerOffset(0.1,() -> attach.rClaw.setPosition(0.25))
                //   .addTemporalMarker(() -> attach.rClaw.setPosition(0.25)) // Raise servo
                .waitSeconds(.3)
                ...
                //.lineToLinearHeading(new Pose2d(25, -28, Math.toRadians(-90)))
                .addTemporalMarker(28,() -> attach.rClaw.setPosition(0))
             //   .UNSTABLE_addTemporalMarkerOffset(-3.5, () -> attach.rClaw.setPosition(0))
        ...
        TrajectorySequence RedLeft= drive.trajectorySequenceBuilder(new Pose2d(0,0,Math.toRadians(0.00)))
                ...
                .lineToLinearHeading(new Pose2d(39, -32, Math.toRadians(-90)))
                .addTemporalMarker(() -> myEncoderLift("ROBOT_DOWN", 0.8, 5, 3, true))
                .waitSeconds(0.3)
                .addTemporalMarker(() -> attach.rRotate.setPosition(0.28)) // Lower servo
                .waitSeconds(0.3)
