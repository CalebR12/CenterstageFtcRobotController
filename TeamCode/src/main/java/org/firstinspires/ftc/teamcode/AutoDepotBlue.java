...
@Autonomous(name="BLUEDepot", group="CenterStage")
//@Disabled
//@Disabled

public class AutoDepotBlue extends AutoBase{
    ...
    public void runOpMode() {
     ...
     /* \\ while (!isStarted()) {
        ...
        if (conePosition == 2) {
            ...
            myEncoderDrive(Direction.STRAFE_RIGHT,DRIVE_SPEED,20,3);
            ...
            myEncoderDrive(Direction.STRAFE_RIGHT,DRIVE_SPEED,10,3);
        }
        else {
