...
@Autonomous(name="BlueDepotRoadrunner", group="ACenterStage")

public class AutoBlueDepotRoadrunner extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence BlueCenter= drive.trajectorySequenceBuilder(new Pose2d(0,0,Math.toRadians(0.00)))
                ...
                .splineToConstantHeading(new Vector2d(33, -15), Math.toRadians(0),
                        SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
              //  .lineToConstantHeading(new Vector2d(28, -15))
                .splineTo(new Vector2d(53, 1),Math.toRadians(90))
                .addTemporalMarker(() -> attach.rRotate.setPosition(0.15))
                .waitSeconds(3.5)
                .lineToConstantHeading(new Vector2d(53, 72))
                .addTemporalMarker(() -> attach.rRotate.setPosition(0.6))
                .lineToConstantHeading(new Vector2d(33, 83))
                ...
                .waitSeconds(.5)
                .lineToConstantHeading(new Vector2d(33, 80))
                .lineToConstantHeading(new Vector2d(44, 80))
        ...
        TrajectorySequence BlueLeft= drive.trajectorySequenceBuilder(new Pose2d(0,0,Math.toRadians(0.00)))
                ...
                .splineToConstantHeading(new Vector2d(15, -5), Math.toRadians(45),
                        SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .splineToConstantHeading(new Vector2d(33, -15), Math.toRadians(45),
                        SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .splineTo(new Vector2d(53, 1),Math.toRadians(90))
                .addTemporalMarker(() -> attach.rRotate.setPosition(0.15))
                ...
                .addTemporalMarker(() -> attach.Claw.setPosition(0.25)) // Raise servo
                .waitSeconds(.5)
                .lineToConstantHeading(new Vector2d(25, 80))
                .lineToConstantHeading(new Vector2d(44, 80))
                .addTemporalMarker(() -> myEncoderLift("ROBOT_UP", 0.8, 7, 3))
        ...
        TrajectorySequence BlueRight= drive.trajectorySequenceBuilder(new Pose2d(0,0,Math.toRadians(0.00)))
                ...
                .splineToConstantHeading(new Vector2d(15, 1), Math.toRadians(-28),
                       SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                       SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .splineTo(new Vector2d(35, 3), Math.toRadians(0),
                      SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                       SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .splineTo(new Vector2d(53, 7),Math.toRadians(90))
                .addTemporalMarker(() -> attach.rRotate.setPosition(0.15))
                .waitSeconds(3.5)
                .lineToConstantHeading(new Vector2d(53, 72))
                .addTemporalMarker(() -> attach.rRotate.setPosition(0.6))
                .lineToConstantHeading(new Vector2d(39, 83))
                .addTemporalMarker(() -> myEncoderLift("ROBOT_DOWN", 0.8, 7, 3))
                .waitSeconds(2)
                .addTemporalMarker(() -> attach.rRotate.setPosition(0.28)) // Lower servo
                .waitSeconds(0.5)
                .addTemporalMarker(() -> attach.Claw.setPosition(0.25)) // Raise servo
                .waitSeconds(.5)
                .lineToConstantHeading(new Vector2d(39, 80))
                .lineToConstantHeading(new Vector2d(44, 80))
                .addTemporalMarker(() -> myEncoderLift("ROBOT_UP", 0.8, 7, 3))
                .build();
